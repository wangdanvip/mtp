...
var webpackConfig = merge(baseWebpackConfig, {
  module: {
    loaders: utils.styleLoaders({ sourceMap: configPath.productionSourceMap, extract: true })
  },
  devtool: configPath.productionSourceMap ? '#source-map' : false,
  output: {
  ...
  vue: {
    loaders: utils.cssLoaders({
      sourceMap: configPath.productionSourceMap,
      extract: true
    })
  },
  plugins: [
...
if (configPath.productionGzip) {
  ...
  webpackConfig.plugins.push(
    new CompressionWebpackPlugin({
      ...
      test: new RegExp(
        '\\.(' +
        configPath.productionGzipExtensions.join('|') +
        ')$'
      ),
      threshold: 10240,
      minRatio: 0.8
