	...
	<div style="overflow: hidden;">
      ...
      <div class="statistics">
        <div class="unit1">
          ...
          <div class="highlight">1000 <span>MB</span></div>
        </div>
        <div class="unit2">
          <div class="unitTitle">
            <span style="margin-left: 10px">使用总流量</span>
            <el-button size="small">流入</el-button>
            <el-button size="small">流出</el-button>
          </div>
          <div class="highlight">1000 <span>MB</span></div>
        </div>
        <div class="unit3">
          <div class="unitTitle">
            <span style="margin-left: 10px">请求总次数</span>
            <el-button size="small">PUT</el-button>
            <el-button size="small">GET</el-button>
          </div>
          <div class="highlight">1000 <span>次</span></div>
        </div>
        <div class="unit4">
          <div class="unitTitle">
            <span style="margin-left: 10px">Bucket总数</span>
          </div>
          <div class="highlight">10 <span>个</span></div>
        </div>
        <div class="unit5">
          <div class="unitTitle">
            <span style="margin-left: 10px">文件总数</span>
          </div>
          <div class="highlight">1000 <span>个</span></div>
        </div>
      </div>
